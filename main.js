...
function writeStory() {
    ...
    madLib.innerHTML = 'Ensign <strong>' + name_one + '</strong> walked into Ten Forward. They ordered a <strong>' + noun + '</strong> and began drinking it. Captain <strong>' + name_two + '</strong> walked in shortly after and with judgment and disgust for what they had ordered, called <strong>' + name_one + '</strong> a <strong>' + mean_adjective + '</strong>. Feeling <strong>' + emotion + '</strong> , <strong>' + name_one + ' began ' + movement + '</strong> and shouted <strong>' + obscenity + '</strong> at Captain <strong>' + name_two + '</strong>. This did not go over well. Lieutenant <strong>' + name_three + '</strong> stepped in with great concern. Emotions grew tense. After several minutes of <strong>' + verb_one + '</strong>, they began to <strong>' + verb_two + '</strong>, and all ordered another round of <strong>' + noun + '</strong> and <strong>' + verb_three + '</strong> the night away.';
